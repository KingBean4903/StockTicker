...
func (x *StockRequest) GetSymbols() []string {
	if x != nil {
		return x.Symbols
	}
	return nil
...
const file_stock_stock_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp2I\n" +
	"\vStockTicker\x12:\n" +
	"\tSubscribe\x12\x13.stock.StockRequest\x1a\x14.stock.StockResponse\"\x000\x01B+Z)github.com/KingBean4903/StockTicker/stockb\x06proto3"
...
var file_stock_stock_proto_depIdxs = []int32{
	0, // 0: stock.StockTicker.Subscribe:input_type -> stock.StockRequest
	1, // 1: stock.StockTicker.Subscribe:output_type -> stock.StockResponse
